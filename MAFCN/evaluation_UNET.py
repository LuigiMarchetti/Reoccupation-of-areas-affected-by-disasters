...
def get_arguments():
    ...
    parser.add_argument("--data_dir", type=str, default='/media/disk2/lmy/khartoum/',
    ...
    parser.add_argument("--restore-from", type=str, default='',
                        help="restored model.")
    parser.add_argument("--snapshot_dir", type=str, default='Maps_khartoum/',
...
def main():
    ...
    models_path = glob.glob(args.restore_from + '*.pth')
    for model_path in models_path:
        ...
        test_mIoU(f, model, testloader, 0, n_class=args.num_classes)
...
if __name__ == '__main__':
    ...
    # saved_state_dict = torch.load('/media/disk2/lmy/dg/MAFCN/smallall1/Snap_MAFCN1_geo_color_adain/Net.pth')
    # model.load_state_dict(saved_state_dict)
    # torch.save(model.state_dict(),'/media/disk2/lmy/dg/MAFCN/smallall1/Snap_MAFCN1_geo_color_adain/Net_1.pkl' , _use_new_zipfile_serialization=False)